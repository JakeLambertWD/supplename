...
function Work({ work }: ProjectProps) {
	...
	const workDescription = work.description && useFormattedDescription(work.description);
	...
	// const matchingAward = awards.find(award => award.work.description === work.description);
	...
	return (
		<>
			{isSM ? (
				<WorkCard workDescription={workDescription} tileImage={work.tileImage} />
			) : (
				<HoverCard
					width={280}
					shadow='xl'
