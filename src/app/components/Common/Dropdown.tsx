...
function Dropdown({ hiddenFromSm, visibleFromSm, open }: { hiddenFromSm?: boolean; visibleFromSm?: boolean; open: any }) {
	...
	return (
		<Menu shadow='xl' width={120}>
			...
			<Menu.Dropdown py={20} px={10} hiddenFrom={hiddenFromSm ? 'sm' : 'none'} visibleFrom={visibleFromSm ? 'sm' : 'none'}>
					...
					{navigationLinks.map((link, index) => {
						...
						return (
							<Text
								...
								onClick={() => (link.label === 'Showreel' ? open() : router.push(link.href))}
